...
<div class="container ">
  <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
    ...
    <div class="card-body">
                ...
                <p class="card-text"><strong>Équipement : </strong> <?=nl2br(str_replace('<br />', '', $vehicule['equipement']));?></p>
                <p class="card-text"><strong>Options : </strong> <?=nl2br(str_replace('<br />', '', $vehicule['options']));?></p>
                <br>
            </div>
