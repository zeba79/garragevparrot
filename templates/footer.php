  ...
  <div class=" mb-0 ">
    <footer class="row ">
        ...
        <ul class="nav flex-column">
          ...
          <li class="nav-item mb-2"><a href="#" class="nav-link p-0 parrot-color">Instagramm</a></li>
          <li class="nav-item mb-2"><a href="#" class="nav-link p-0 parrot-color">Tweeter</a></li>
          <li class="nav-item mb-2"><a href="#" class="nav-link p-0 parrot-color">Snapchat</a></li>
        </ul>
      </div>
