...
define('HOME_VEHICULES_LIMIT', 4);
define('HOME_COMMENTAIRES_LIMIT', 6);
define('ADMIN_VEHICULES_LIMIT', 4);
define('ADMIN_EMPLOYEES_LIMIT', 2);
define('ADMIN_COMMENTS_LIMIT', 4);
